...
// console.log( undefined && null );
console.log('sunny' && true && 0 && null  && undefined && '');
...
// obj1.id= obj1.id || 10;
// obj2.id= obj2.id || 10;
// console.log(obj1, obj2); //{ name: 'jamal', id: 10 } { name: 'kamal', id: 10 }
...
obj1.id ??= 10;
obj2.id ??= 10;
// console.log(obj1, obj2); //{ name: 'jamal', id: 0 } { name: 'kamal', id: 10 }


obj1.id=obj1.id &&= '<ANONYMOUS>';
obj2.id=obj2.id &&= '<ANONYMOUS>';
console.log(obj1,obj2); //{ name: 'jamal', id: 0 }  { name: 'kamal', id: '<ANONYMOUS>' }
